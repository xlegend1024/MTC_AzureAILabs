...
## Audience
This lab targets developers who may not have an AI/ML background. If there are participants who are new to AI/ML topics, the instructor should introduce key AI, Machine Learning and Deep Learning concepts. This repo includes two teaching tools that instructors are free to use:
